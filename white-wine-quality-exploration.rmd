...
the dataset has 4898 observations. Each observation represents a white wine and that white wine has 11 attributes (fixed acidity, volatile acidity, ), and 1 output variable (white wine quality)
